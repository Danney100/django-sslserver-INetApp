...
sys.path.append('C:/VoiceSolutions/iNet4-Server')
sys.path.append('C:/VoiceSolutions/iNet4-Server/INetApp')

os.environ['DJANGO_SETTINGS_MODULE'] = 'INetApp.settings'
# os.environ.setdefault("DJANGO_SETTINGS_MODULE", "my_application.settings")
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "INetApp.settings")
