...
function startUploading(blob1) {
	...
	let formatted_date = (d.getMonth() + 1) + " " + d.getDate()  + " " + d.getFullYear() + " " + d.getHours() + " " + d.getMinutes() + " " + d.getSeconds()
	console.log(formatted_date)

	// var uploadFileName = new Date().toISOString() + '.'+extension;
    //var uploadFileName = year + ' ' + ms + ' 0 0 0 0 0 P' + '.'+extension;
	var wt = "WT"
	var subject = "SUBJECT"
	var Exc = "01"
	var dept = "1"
	...
	var auth_id = "111"
	var jobNum = "0000"
	var uploadFileName = jobNum + ' 0 ' + auth + ' ' + auth_id + ' ' + formatted_date + " " + dept + ' ' + Exc + ' ' + wt + ' ' +subject + ' ' + ms + ' ' + "0.eW2"
	console.log(uploadFileName)
	var fd=new FormData();
	fd.append("audio_data",blob1, uploadFileName);
	xhr.open("POST","https://dictationportal.com:4445/upload-PCD3.php",true);
	xhr.send(fd);
